...
export const config: IConfig = {
    welcome: "Welcome to Gabriel Musat´s resume",
    basicInfo: {
    ...
    mainPhoto: require("./images/gabi.jpg"),
    job: 'Full stack and machine learning software engineer',
    languages: ["spanish", "english"],
    technology: {
        "Programming languages": ["python", "javascript", "typescript", "go", "java", "cpp"],
    ...
    education: [
        {
            university: require("./images/UC3M.png"),
